...
const Chat = () => {
    ...
    return (
        <div className={voiceCall ? "chat-main-body chat-main-body-voice-call" : "chat-main-body"}>
            {/* <Avatar/> */}
            {/* <aside className=''> */}
            {/* <img src="./src/assets/AI avatar placeholder.png" alt="avatar" className="h-auto w-full" /> */}
            <iframe className={voiceCall ? "body flex basis-1/2 self-center justify-center sm-cen max-scrn-voice-call" : "body flex basis-1/2 self-center justify-center"} src='https://my.spline.design/untitled-c5b03b378e7ce3125486f2d1db14c585/' frameBorder='0'></iframe>
            {/* </aside> */}
            ...
            <div className={voiceCall ? "hidden" : "chat-div"}>
            ...
            </div>
            {
                ...
                <div className="flex justify-between z-10  p-3 gap-5 rounded-full absolute bottom-10">
                    <button className="flex flex-col items-center bg-red-700 pb-1 text-white rounded-full w-40 justify-center" onClick={handleEndCall}>
                        <span className="material-symbols-outlined">
                            call_end
                        </span>
                        End Call
