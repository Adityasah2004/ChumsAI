    ...
    return (
        <footer className="flex flex-col py-5 items-center">
            <div className="footer-div1 text-white w-full">
                <div className="footer-logo-div flex items-center justify-center">
            ...
            <div className="footer-last-div w-10/12 text-white flex justify-between items-center py-5 gap-2">
                ...
                <div className="flex items-center gap-4">
                    <a href="https://discord.gg/5dMV9bvTSA">
                    ...
                    <a href="https://www.facebook.com/people/CHUMS-AI/61557566630374/">
                    ...
                    <a href="https://www.instagram.com/chums.ai">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
