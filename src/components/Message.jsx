    ...
    return (
        <div className={`${props.cName}`}>
            ...
            <div className="flex flex-col relative">
                <p className="message-p text-black items-center p-2 pl-3 rounded-r-xl rounded-bl-xl bg-white bg-opacity-80 h-auto w-auto gap-1 flex relative overflow-hidden text-left chat-p" onMouseEnter={() => setMessageMenu(true)} onMouseLeave={() => setMessageMenu(false)}>
                    {props.message}
                    {messageMenu &&
